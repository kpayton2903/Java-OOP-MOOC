...
public class AVL<T extends Comparable<? super T>> {
    ...
    public void updateHeightAndBF(AVLNode<T> currentNode) {
        currentNode.setHeight(Math.max(findHeight(currentNode.getLeft()), findHeight(currentNode.getRight())) + 1); 
        currentNode.setBalanceFactor(findHeight(currentNode.getLeft()) - findHeight(currentNode.getRight()));
    }
